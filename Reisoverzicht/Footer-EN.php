...
<section class="footer"><!--FOOTER SECTION START-->
 <div class="box-container">
    <div class="box">
        <h3>About Us</h3>
        <p>XtremeLOVE is a newly created travel website, go on a adventure with your loved one's and create an unforgetable time.</p>
    </div>
        <div class="box">
    ...
    <h1 class="credit"> Made with <span>&#10084;</span> by <span> SD21-5 </span> | Copyright © 2021, Xtreme<span>LOVE</span>. All rights reserved.</h1>
    </section>
